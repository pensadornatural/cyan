...
module cyan {
    ...
    const StandardSkin = {
        ...
        ToolBoxColor: 'rgba(255,255,255,0.95)',
        ToolBoxIconColor: 'rgb(140,140,140)',
        ToolBoxIconDisabledColor: 'rgb(220,220,220)',
        ToolBoxTop: 0,
        StatusBarHeight: 22,
        ...
        DocumentColor: 'rgba(255,255,255,0.95)',
        DocumentBorderColor: 'rgb(245,245,245)',
        DocumentTitleBarFontColor: Const.FacebookBlue,
        ...
        DocumentTitleBarButtonColor: 'rgb(150,150,150)',
        DocumentTitleBarButtonColorOnMouseOver: 'rgb(46,131,223)',
        DocumentTitleBarDisabledButtonColor: 'rgb(200,200,200)',
        ...
        ButtonColor: Const.White,
        ButtonFromBackColor: Const.Blue,
        ButtonToBackColor: Const.Blue,
        ...
        ButtonBorderTopColor: Const.White,
        ButtonBorderRightColor: Const.White,
        ButtonBorderBottomColor: Const.White,
        ButtonBorderLeftColor: Const.White,
    ...
    export class Skin {
        ...
        public static SetToolBoxShow(value: boolean) {
            ...
            if (value) {
                ...
                document.getElementById("lblCyanEscritorioZTitulo").style.visibility = 'hidden';
        ...
        public static SetToolBoxTableIcons(value: boolean) {
            ...
            if (value && Skin.ToolBoxShow) {
                document.getElementById("lblCyanEscritorioZTitulo").style.visibility = 'visible';
        ...
        public static SetToolBoxIconDisabledColor(value: string) {
            ...
            document.getElementById('lblCyanEscritorioZTitulo').style.color = value;
        }
    ...
    export function Begin() { //Este comando es fundamental: debe ser llamado siempre por la aplicación que desee utilizar esta librería.
        ...
        lblCyanVersion.SetWidth(50);

        // Crear funciones de escritorio.
        let SeparacionEntreIconos: number = 15;
        ...
        nodoNuevo.style.height = "28px";
        nodoNuevo.style.backgroundColor = Skin.GetToolBoxColor();
        nodoNuevo.style.outline = "0";
        nodoNuevo.style.borderBottomColor = "rgb(200,200,200)";
        nodoNuevo.style.borderBottomWidth = "1px";
        nodoNuevo.style.borderBottomStyle = "solid";
        document.body.appendChild(nodoNuevo);

        // Función Despliegue del Z actualmente visible por el ViewFinder.
        // var lblCyanEscritorioZTitulo = new Label("Cyan", 5, Skin.GetToolBoxTop() + 7, 0, String(Table.GetViewFinderZ()), "lblCyanEscritorioZTitulo");
        // lblCyanEscritorioZTitulo.SetCrossZ(true);
        // lblCyanEscritorioZTitulo.SetLink(true);
        // lblCyanEscritorioZTitulo.SetFontSize(12);
        // lblCyanEscritorioZTitulo.SetEnabled(false);
        // lblCyanEscritorioZTitulo.SetWidth(30);
        // lblCyanEscritorioZTitulo.SetHeight(32);
        // lblCyanEscritorioZTitulo.SetZIndex(String(ZIndexIconosEscritorio));
        // document.getElementById("lblCyanEscritorioZTitulo").style.textAlign = "center";
        // document.getElementById("lblCyanEscritorioZTitulo").style.color = Skin.GetToolBoxIconDisabledColor();
        // document.getElementById("lblCyanEscritorioZTitulo").innerText = "MESA";
        // document.getElementById("lblCyanEscritorioZTitulo").style.setProperty("position", "fixed");
        // document.getElementById("lblCyanEscritorioZTitulo").setAttribute('title','Mesa actual / Current table');

        var lblCyanEscritorioZ = new Label("Cyan", 2, Skin.GetToolBoxTop() + 2, 0, String(Table.GetViewFinderZ()), "lblCyanEscritorioZ");
        lblCyanEscritorioZ.SetCrossZ(true);
        lblCyanEscritorioZ.SetLink(true);
        lblCyanEscritorioZ.SetFontSize(19);
        lblCyanEscritorioZ.SetEnabled(false);
        lblCyanEscritorioZ.SetWidth(34);
        lblCyanEscritorioZ.SetHeight(27);
        ...
        // document.getElementById("lblCyanEscritorioZ").style.color = 'rgb(226,76,50)';
        document.getElementById("lblCyanEscritorioZ").style.color = Const.Blue;
        ...
        var lblCyanEscritorioOrdenarDocumentosRecoger = new Label("Cyan", lblCyanEscritorioZ.GetX() + lblCyanEscritorioZ.GetWidth() + SeparacionEntreIconos, Skin.GetToolBoxTop() - 6, 0, "\u2601", "lblCyanEscritorioOrdenarDocumentosRecoger");
        lblCyanEscritorioOrdenarDocumentosRecoger.SetCrossZ(true);
        lblCyanEscritorioOrdenarDocumentosRecoger.SetLink(true);
        lblCyanEscritorioOrdenarDocumentosRecoger.SetFontSize(28);
        lblCyanEscritorioOrdenarDocumentosRecoger.SetWidth(34);
        lblCyanEscritorioOrdenarDocumentosRecoger.SetHeight(34);
        ...
        var lblCyanEscritorioOrdenarDocumentosSoltar = new Label("Cyan", lblCyanEscritorioOrdenarDocumentosRecoger.GetX() + lblCyanEscritorioOrdenarDocumentosRecoger.GetWidth() + SeparacionEntreIconos - 3, Skin.GetToolBoxTop() - 10, 0, "\u2b0e", "lblCyanEscritorioOrdenarDocumentosSoltar");
        lblCyanEscritorioOrdenarDocumentosSoltar.SetCrossZ(true);
        lblCyanEscritorioOrdenarDocumentosSoltar.SetLink(true);
        lblCyanEscritorioOrdenarDocumentosSoltar.SetFontSize(37);
        lblCyanEscritorioOrdenarDocumentosSoltar.SetWidth(34);
        lblCyanEscritorioOrdenarDocumentosSoltar.SetHeight(38);
        ...
        // Función ir a Z = 0.
        var lblCyanEscritorioZInicio = new Label("Cyan", lblCyanEscritorioOrdenarDocumentosSoltar.GetX() + lblCyanEscritorioOrdenarDocumentosSoltar.GetWidth() + SeparacionEntreIconos - 11, Skin.GetToolBoxTop() - 8, 0, "\u2302", "lblCyanEscritorioZInicio");
        lblCyanEscritorioZInicio.SetCrossZ(true);
        lblCyanEscritorioZInicio.SetLink(true);
        lblCyanEscritorioZInicio.SetFontSize(33);
        lblCyanEscritorioZInicio.SetWidth(34);
        lblCyanEscritorioZInicio.SetHeight(36);
        ...
        // Función Z adelante.
        var lblCyanEscritorioZAdelante = new Label("Cyan", lblCyanEscritorioZInicio.GetX() + lblCyanEscritorioZInicio.GetWidth() + SeparacionEntreIconos - 10, Skin.GetToolBoxTop() - 12, 0, "\u21d7", "lblCyanEscritorioZAdelante");
        lblCyanEscritorioZAdelante.SetCrossZ(true);
        lblCyanEscritorioZAdelante.SetLink(true);
        lblCyanEscritorioZAdelante.SetFontSize(36);
        lblCyanEscritorioZAdelante.SetWidth(34);
        ...
        // Función Z atrás.
        var lblCyanEscritorioZAtras = new Label("Cyan", lblCyanEscritorioZAdelante.GetX() + lblCyanEscritorioZAdelante.GetWidth() + SeparacionEntreIconos - 10, Skin.GetToolBoxTop() - 12, 0, "\u21d9", "lblCyanEscritorioZAtras");
        lblCyanEscritorioZAtras.SetCrossZ(true);
        lblCyanEscritorioZAtras.SetLink(true);
        lblCyanEscritorioZAtras.SetFontSize(36);
        lblCyanEscritorioZAtras.SetWidth(34);
        ...
        var lblCyanEscritorioOrdenarDocumentosSolapado = new Label("Cyan", lblCyanEscritorioZAtras.GetX() + lblCyanEscritorioZAtras.GetWidth() + SeparacionEntreIconos - 10, Skin.GetToolBoxTop() - 9, 0, "\u25f0", "lblCyanEscritorioOrdenarDocumentosSolapado");
        lblCyanEscritorioOrdenarDocumentosSolapado.SetCrossZ(true);
        lblCyanEscritorioOrdenarDocumentosSolapado.SetLink(true);
        lblCyanEscritorioOrdenarDocumentosSolapado.SetFontSize(33);
        lblCyanEscritorioOrdenarDocumentosSolapado.SetWidth(34);
        lblCyanEscritorioOrdenarDocumentosSolapado.SetHeight(37);
        ...
        var lblCyanEscritorioOrdenarDocumentosHorizontal = new Label("Cyan", lblCyanEscritorioOrdenarDocumentosSolapado.GetX() + lblCyanEscritorioOrdenarDocumentosSolapado.GetWidth() + SeparacionEntreIconos, Skin.GetToolBoxTop() - 8, 0, "\u2505", "lblCyanEscritorioOrdenarDocumentosHorizontal");
        lblCyanEscritorioOrdenarDocumentosHorizontal.SetCrossZ(true);
        lblCyanEscritorioOrdenarDocumentosHorizontal.SetLink(true);
        lblCyanEscritorioOrdenarDocumentosHorizontal.SetFontSize(30);
        lblCyanEscritorioOrdenarDocumentosHorizontal.SetWidth(34);
        lblCyanEscritorioOrdenarDocumentosHorizontal.SetHeight(36);
        ...
        var lblCyanEscritorioOrdenarDocumentosVertical = new Label("Cyan", lblCyanEscritorioOrdenarDocumentosHorizontal.GetX() + lblCyanEscritorioOrdenarDocumentosHorizontal.GetWidth() + SeparacionEntreIconos - 8, Skin.GetToolBoxTop() - 2, 0, "\u2507", "lblCyanEscritorioOrdenarDocumentosVertical");
        lblCyanEscritorioOrdenarDocumentosVertical.SetCrossZ(true);
        lblCyanEscritorioOrdenarDocumentosVertical.SetLink(true);
        lblCyanEscritorioOrdenarDocumentosVertical.SetFontSize(23);
        lblCyanEscritorioOrdenarDocumentosVertical.SetWidth(34);
        lblCyanEscritorioOrdenarDocumentosVertical.SetHeight(30);
    ...
    export class Cyan {
        ...
        //a costa de perder el control y una carga en desorden, aquí en Cyan JS se cargan asíncronamente pero de manera secuencial: cada objeto que se añade a la pila es procesado, y solo cuando
        ...
        public static Talk(message: string, metaMessage: any = "") {
            ...
            try {
                window["Desk_Listen"].call(this, "Cyan", message, metaMessage);
            } catch(e) {}
            try {
    ...
    export class Table {
        ...
        public static SetWidth(width: number) { //El valor del ancho de la mesa se usa en realidad como coordenada X de la firma, para crear con eso las dimensiones de la mesa.
            if (width < window.innerWidth) {
                width = window.innerWidth - 50; //Se descuenta el ancho de la firma.
            }
        ...
        public static OrganizeDocuments(OrganizationType: string, SetOfDocuments: string = Const.OrganizeVisibleDocuments) {
            let MargenIzquierdoEscritorioOrganizacionDocumentos: number = 20;
    ...
    export class Document {
        ...
        constructor(x: number = 0, y: number = 0, z: number = 0, width: number = 0, height: number = 0, caption: string = "", id: string) {
            ...
            //Líneas de fondo.
            nodoBarraTitulo.style.backgroundImage = "linear-gradient(rgba(0,122,134,0) 2px, transparent 1px),linear-gradient(90deg, rgba(0,122,134,0) 1px, transparent 1px),linear-gradient(rgba(0,122,134,0.05) 1px, transparent 1px),linear-gradient(90deg, rgba(0,122,134,0) 1px, transparent 1px)";
            ...
            nodoTitulo.dataset.Cyanheight = String(Skin.GetDocumentTitleBarHeight());
